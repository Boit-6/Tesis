...
export default function RegisterForm() {
  ...
  if (checkEmail) {
    return (
      <div className="flex flex-col items-start gap-5 border border-rule-soft bg-card px-8 py-14">
        <svg
          fill="none"
          height={36}
          stroke="#8f5f22"
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
      ...
      <button
        className="ease w-full bg-ink py-4.5 text-[11px] font-medium tracking-[0.2em] text-paper uppercase transition duration-200 hover:bg-ochre disabled:cursor-not-allowed disabled:opacity-40"
        disabled={loading}
        type="submit"
      >
